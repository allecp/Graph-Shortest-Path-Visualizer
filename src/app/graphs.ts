...
const graphs: {nodes: Node[], edges: Edge[]}[] = [
    ...
    },
    {
        nodes:
        [
            {id: '0', type: 'graphNode', position: {x:50, y: 0}, data : {value: '0', processed:false}},
            {id: '1', type: 'graphNode', position: {x:200, y: 100}, data : {value: '?', processed:false}},
            {id: '2', type: 'graphNode', position: {x:50, y: 100}, data : {value: '?', processed:false}},
            {id: '3', type: 'graphNode', position: {x:200, y: 0}, data : {value: '?', processed:false}},
            {id: '4', type: 'graphNode', position: {x:50, y: -100}, data : {value: '?', processed:false}},
            {id: '5', type: 'graphNode', position: {x:200, y: -100}, data : {value: '?', processed:false}},

        ],
    edges:
        [
            {id:"0",type: "customEdge", sourceHandle: "s", source: '0', target: "3", targetHandle: "t", style: {stroke:"white"}, data:{weight:5}},
            {id:"1",type: "customEdge", sourceHandle: "s", source: '0', target: "4", targetHandle: "t", style: {stroke:"white"}, data:{weight:1}},
            {id:"2",type: "customEdge", sourceHandle: "s", source: '0', target: "7", targetHandle: "t", style: {stroke:"white"}, data:{weight:6}},
            {id:"3",type: "customEdge", sourceHandle: "s", source: '5', target: "3", targetHandle: "t", style: {stroke:"white"}, data:{weight:7}},
            {id:"4",type: "customEdge", sourceHandle: "s", source: '4', target: "5", targetHandle: "t", style: {stroke:"white"}, data:{weight:12}},
            {id:"5",type: "customEdge", sourceHandle: "s", source: '0', target: "2", targetHandle: "t", style: {stroke:"white"}, data:{weight:3}},
            {id:"6",type: "customEdge", sourceHandle: "s", source: '2', target: "1", targetHandle: "t", style: {stroke:"white"}, data:{weight:2}},
            {id:"7",type: "customEdge", sourceHandle: "s", source: '1', target: "3", targetHandle: "t", style: {stroke:"white"}, data:{weight:3}},
            {id:"8",type: "customEdge", sourceHandle: "s", source: '4', target: "3", targetHandle: "t", style: {stroke:"white"}, data:{weight:4}},
            {id:"9",type: "customEdge", sourceHandle: "s", source: '3', target: "2", targetHandle: "t", style: {stroke:"white"}, data:{weight:6}},
        ]
    }
]
